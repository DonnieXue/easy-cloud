...
public class GenerateJavaTest {
	...
	// pojo类所在的项目名称
	private String projectNamePojo = "easy-cloud-core-oauth";
	// dao类所在的项目名称
	private String projectNameDao = "easy-cloud-core-oauth";
	// service类所在的项目名称
	private String projectNameService = "easy-cloud-core-oauth";
	// controller类所在的项目名称
	private String projectNameController = "easy-cloud-core-oauth";
	// mybatis配置文件所在的项目名称
	private String projectNameMybatis = "easy-cloud-core-oauth";
	// 基础包名称
	...
	private void initModuleData() {
		moduleName = EcStringUtils.replace(tableName, "_", "");
		classBodyName = EcStringUtils.capitalize(EcStringUtils.replaceUnderLineAndUpperCase(tableName));
	}
