...
public class EcIdWorker {

    private final static Logger logger = LoggerFactory.getLogger(EcIdWorker.class);
    ...
    private EcIdWorker(long workerId) {
    ...
    public synchronized long nextId(){
        long timestamp = EcIdWorker.timeGen();
...
//            throw new Exception(String.format("clock moved backwards.Refusing to generate id for %d milliseconds", (this.lastTimestamp - timestamp)));
    ...
    private static EcIdWorker flowIdWorker = new EcIdWorker(1);

    public static EcIdWorker getFlowIdWorkerInstance() {
        return flowIdWorker;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        EcIdWorker idWorker = EcIdWorker.getFlowIdWorkerInstance();
